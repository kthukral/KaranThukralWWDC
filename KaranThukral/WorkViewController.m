...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        cell.textView.text = @"Shopify is an e-commerce platform that enables the masses to create, manage and run online stores. I am going to be working full time over the summer on thier iOS applications mainly for the iPhone. The app enables the user to manage their stores, orders and also accept credit card payments in person using an external accessory. I am very excited to start my work term at the company and WWDC will provide me the with the knowledge to better inprove the application.";
    } else if (indexPath.row == 1){
        cell.companyName.text = @"Canadian Broadcasting Coorporation";
        cell.imageView.image = [UIImage imageNamed:@"CBCLogo.jpg"];
        cell.textView.text = @"I worked at the Canandian Broadcasting Coorporation (CBC) from September to December 2013 as an iOS Developer. While working there I was given a project by the lead iOS Developer to recreate thier news application in a completely native fasion using the newely released iOS 7. This project involved using the new API's like Text Kit, and also creating a parser to parse HTML and dynamically layout views. This app was meant as a prototype for internal use and help determine the future direction of the apps that the company wanted to undertake. Screenshots of the application can be found on my website: ";
        ...
        cell.textView.text = @"I worked at Kik as a Mobile Testing Specialist for 4 months. The job included of manually conducting tests on the application for every feature and new release. I also wokred on creating automated tests for Android using the Calabash Android Framework. Over my coop term I created two \"Kik Cards (web applications)\" \"Kik Your Memes\" and \"Kik Tech News\". I also started my iOS Developement experience my creating sample applications like \"QTip\". All these applications are available on my GitHub: " @" http://github.com/kthukral";
    }
